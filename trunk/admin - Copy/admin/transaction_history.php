       ...
       <section class="content-header">
				  <div class="row">
					<div class="col-md-6">
						...
						<div class="col-md-6">
						<a class="btn  btn-primary btn-md pull-right clearfix btn-sm" href="transferd.php" >Transfered</a>
						<a class="btn  btn-primary btn-md pull-right clearfix btn-sm m-r-10" href="notTransferd.php" >NotTransfered</a>
					</div>
						...
						<div class="box-body">
							<div class="dataTables_wrapper form-inline dt-bootstrap" id="example1_wrapper">
								<div class="row" id="practitionerlistsction">
									<div class="col-sm-12">
										<table class="table " id="practitionertab">
											<thead>
												<tr>
													<th>Category</th>
													<th>Company Name</th>
