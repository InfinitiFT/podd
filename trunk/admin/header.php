            ...
            <!-- sidebar menu -->
                   ...
                   <li><a href = "service_management_list.php"><i class="fa fa-windows"></i>Service</a></li>
				    ...
				    <li><a href = "#"><i class="fa fa-home"></i>Home Page</a>
                       <ul class="nav child_menu">
                          <li><a href="home_page_listing.php">Big Screen</a></li>
                          <li><a href="restaurant_logo_with_name.php">Small Screen</a></li>
                   ...
                   <li><a href = "#"><i class="fa fa-home"></i>Restaurant & Bars</a>
                       <ul class="nav child_menu">
                          ...
                          <li><a href="booking_history.php">History</a></li> 
						   <li><a href = "restaurant_term_condition.php">Terms & Conditions</a></li>
                      </ul>
                  </li> 
                   <li><a href = "#"><i class="fa fa-car"></i>Taxi</a>
				       <ul class="nav child_menu">
                        <li><a href = "taxi_term_condition.php">Terms & Conditions</a></li> 
                      </ul>
				   </li>
                  
				
				   
                   <li><a href = "#"><img src="<?php echo url1();?>uploads/logo/icon2.png">Delivery</a>
                   <ul class="nav child_menu">
                      <li><a href="booking_list_restaurant_delivery.php">Order Management</a></li>
                      <li><a href="booking_history_delivery.php">History</a></li> 
					   <li><a href = "delivery_term_condition.php">Terms & Conditions</a></li>
                  </ul>
				  <li><a href = "#"><i class="fa fa-plane"></i>Airport Transfer</a>
                   <ul class="nav child_menu">
                      <li><a href="airport_page_listing.php">Request Management</a></li>
                      <li><a href="airport_history_list.php">History</a></li> 
					   <li><a href = "airport_term_condition.php">Terms & Conditions</a></li>
                  </ul>
                  </ul>
             ...
             <?php } elseif($_SESSION['role']=="2"){?>
                 <ul class="nav side-menu">
                   ...
                   <li><a href = "venue_meal.php"><img src="<?php echo url1();?>uploads/logo/icon3.png">Menu Management</a></li>
                   <li><a href = "booking_glance.php"><img src="<?php echo url1();?>uploads/logo/icon1.png">Table Management</a></li>
                   <li><a href = "booking_history.php"><img src="<?php echo url1();?>uploads/logo/icon4.png" style="margin-right: 16px;margin-left: 6px;">History</a></li>
                    <li><a href = "#"><img src="<?php echo url1();?>uploads/logo/icon2.png">Delivery</a>
                   <ul class="nav child_menu">
