<?php 
  ...
  $result = array();
  $data = mysqli_query($GLOBALS['conn'],"SELECT * FROM restaurant_details rd join restaurant_meal_details rmd on rd.restaurant_id = rmd.restaurant_id WHERE rd.status = 1 AND rmd.deliver_food = 1 group by rd.restaurant_id");
  //Basic Validation  
  $msg ='';
