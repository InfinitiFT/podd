...
try {
      ...
      { 
        if($_FILES["image"]['name'])
		{
			  ...
			  $target_dir = "../uploads/home_page_image/";
			  //$target_dir = $_SERVER['DOCUMENT_ROOT']."/trunk/uploads/home_page_image/";
			  $target_path    = $target_dir . $home_page_image1;
			  if(move_uploaded_file($_FILES['image']['tmp_name'], $target_path)) 
			  {
				 $message = mysqli_real_escape_string($conn,trim($_POST['message']));
				if(mysqli_query($GLOBALS['conn'],"INSERT INTO `home_page_image`(`image_message`, `image_url`) VALUES ('".$message."','". 'uploads/home_page_image/'.$home_page_image1 . "')")){
				  $_SESSION["successmsg"] = "Home data added successfully.";
			...
			else
			{
			 ...
			 $message = mysqli_real_escape_string($conn,trim($_POST['message']));
				if(mysqli_query($GLOBALS['conn'],"INSERT INTO `home_page_image`(`image_message`) VALUES ('".$message."')")){
				  $_SESSION["successmsg"] = "Home data added successfully.";
				  header('Location:home_page_listing.php');
				 }
				else
                ...
                <div class="x_panel">
                  ...
                  <?php }else{}?>
                      ...
                      <div class="item form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Message</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="message" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" value="<?php if(isset($_POST['submit'])){
                             print $_POST['message'];} ?>" name="message" placeholder="Name"  type="text">
                        </div>
                      </div>
                      <div class="item form-group">
