...
try {
      ...
      { 
        ...
        if(mysqli_query($GLOBALS['conn'],"UPDATE `static_page` SET `name`='".$name."',`content`= '".$content."' WHERE id = 4")){
        ...
        $static_data = mysqli_fetch_assoc(mysqli_query($GLOBALS['conn'],"SELECT * FROM `static_page` WHERE id = 4"));
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Airport Terms & Conditions</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
