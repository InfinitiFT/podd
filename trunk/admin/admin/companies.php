					...
					<div class="box">
						<div class="box-body">
							<div class="dataTables_wrapper form-inline dt-bootstrap" id="example1_wrapper">
								<div class="row" id="companylistsection">
									<div class="col-sm-12">
										<table class="table " id="companytab">
											<thead>
												<tr>
													<th>Company Name</th>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button class="btn btn-primary" type="button" id="adminRemoveCompany">Yes</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal-dialog -->
			</div>
