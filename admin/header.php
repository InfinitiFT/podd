            ...
            <!-- sidebar menu -->
                ...
                <ul class="nav side-menu ">
                 ...
                 <ul class="nav side-menu">
				   ...
				   <li><a href = "static_message.php?page_id= <?php echo encrypt_var('1');?>"><i class="fa fa-envelope"></i>Static Message</a></li>
				   <li><a href = "static_message.php?page_id= <?php echo encrypt_var('2');?>"><i class="fa fa-envelope"></i>Terms & Conditions</a></li>
